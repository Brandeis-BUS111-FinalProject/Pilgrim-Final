...
lm_profit_Inc = lm(X9Profit ~ factor(X9Age) + factor(X9Inc) + X9Online * factor(X9Age) + X9Billpay 
                       * factor(X9Age) + X9Online * factor(X9Inc), data = consumerDB)

lm_profit_Tenure = lm(X9Profit ~ factor(X9Age) + factor(X9Inc) + X9Online * factor(X9Age) 
                      + X9Billpay * factor(X9Age) + X9Online * factor(X9Inc) + X9Tenure 
                      * factor(X9Age) + X9Tenure * factor(X9Inc), data = consumerDB)
...
lm_retention_Inc = lm(retention ~ factor(X9Age) + factor(X9Inc) + X9Online * factor(X9Age)
                      + X9Online * factor(X9Inc), data = consumerDB)

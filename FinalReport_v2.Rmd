...
### 4. Mean profitability of years 1999 and 2000 customers using online banking or electronic billpay or not
...
### 5. Use of the online channel effect on the regression analysis.
...
### 6. Profit Models and Retention Model 
...
training.data = subset(consumerDB2,randOrder < .9 * nrow(consumerDB2)) ## new revision
validation.data =  subset(consumerDB2,randOrder>=.9*nrow(consumerDB2)) ## new revision
```
...
comparison.table.profit = matrix(c(summary(lm_profit_Online)$adj.r.square, AIC(lm_profit_Online), BIC(lm_profit_Online), prediction.error1, summary(lm_profit_Age)$adj.r.square, AIC(lm_profit_Age), BIC(lm_profit_Age), prediction.error2, summary(lm_profit_Billpay)$adj.r.square, AIC(lm_profit_Billpay), BIC(lm_profit_Billpay), prediction.error3,summary(lm_profit_Inc)$adj.r.square, AIC(lm_profit_Inc), BIC(lm_profit_Inc), prediction.error4, summary(lm_profit_Tenure)$adj.r.square, AIC(lm_profit_Tenure), BIC(lm_profit_Tenure), prediction.error5, summary(lm_profit_final)$adj.r.square, AIC(lm_profit_final), BIC(lm_profit_final), prediction.error6), nrow = 6, ncol = 4, byrow = TRUE)
...
rownames(comparison.table.profit) = c("lm_profit_Online", "lm_profit_Age",  "lm_profit_Billpay ","lm_profit_Inc", "lm_profit_Tenure", "lm_profit_final")
...
comparison.table.retention = matrix(c(summary(lm_retention_Online)$adj.r.square, 
                                      AIC(lm_retention_Online), BIC(lm_retention_Online), prediction.error.retention1, summary(lm_retention_Age)$adj.r.square, AIC(lm_retention_Age), BIC(lm_retention_Age), prediction.error.retention2, summary(lm_retention_Billpay)$adj.r.square, AIC(lm_retention_Billpay), BIC(lm_retention_Billpay), prediction.error.retention3, summary(lm_retention_Inc)$adj.r.square, AIC(lm_retention_Inc), BIC(lm_retention_Inc), prediction.error.retention4, summary(lm_retention_Tenure)$adj.r.square, AIC(lm_retention_Tenure), BIC(lm_retention_Tenure), prediction.error.retention5, summary(lm_retention_final)$adj.r.square, AIC(lm_retention_final), BIC(lm_retention_final), prediction.error.retention6), nrow =6, ncol = 4, byrow = TRUE)
...
rownames(comparison.table.retention) = c("lm_retention_Online", "lm_retention_Age", "lm_retention_Billpay", "lm_retention_Inc", "lm_retention_Tenure", "lm_retention_final")
...
### 7. Test of the final Profit Model and Retention Model
```{r}
...
### 8. Summarizatoin and Recommendation

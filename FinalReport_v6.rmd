...
```
Type 1 represents customers with no online account and no billpay; Type 2 represents customers with online account but no billpay; Type 3 represents customers with both online account and billpay; and Type 4 represents those customers leave the bank. So 17% of those customers with no online account and no billpay in 1999 leave the bank in 2000; 14% of  those customers with online account but no billpay in 1999 leave the bank in 2000; and 15% of those customers with both online account and  billpay in 1999 leave the bank in 2000. Although there is no obvious differences amoung these percentages, it still shows that those who have no online account and no billpay have the highest posibility to leave the bank.
...
There is a significant regression equation was found (p= 0.001597 < 0.05).That is saying, there is significant difference on customer profitability between the use of the online banking& billpay and not using the online banking& billpay. Adjusted R square is 0.001597, meaning that 0.16% of the variance in profit can be explain by using Online banking and billpay.
...
According to the result, the prediction error of our Profit Model is 382.8064. Meanwhile, 84% of the prediction is correct for our Retention Model, which is pretty accurate. In general, our Profit Model and Retention Model could fairly predict the profit and retention status of Pilgrim Banks' customers.
...
```
In order to estimate the total profit range, we run our Profit Model and extracted 95% of the dataset's profit of the lower and upper limit. After we added all the predicted upper limited, we got the highest total profit of 179864.4; and in the same way, we got the lowest total profit of 128974.3. So the range of 2000's profit is from 128974.3 to 179864.4

...
Database is a subset that only contains 26396 observations and 14 variables. It's a subset from the orginal dataset. According to the request, Database2000 only contains those observations that don't have any missing data in 2000 Online, 2000 profit and 2000 billpay.
